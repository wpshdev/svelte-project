...
export async function load(params) {
    const url = 'https://strapi.ulfbuilt.com:1337/api/portfolios?filters[slug][$eq]='+params.params.slug+'&populate=deep,3';
    const headers = {
    ...
    const rpUrl = 'https://strapi.ulfbuilt.com:1337/api/portfolios?filters[categories][id][$eq]='+randomCat+'&populate=deep,3';
