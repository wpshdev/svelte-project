  ...
  <Navbar expand="md">
	<NavbarBrand href="/">
		<div class="logo-container">
			<img loading="lazy" loading="lazy" src={siteSettings.Header.Logo.data ? domain+siteSettings.Header.Logo.data.attributes.url : logo} alt="ULFBUILT" class="logo" width="330" height="170" />
		</div>
	</NavbarBrand>
	{#if !isOpen}
		<!-- svelte-ignore a11y-click-events-have-key-events -->
		<div class="{isOpen ? "hamburger open" : "hamburger close" }" on:click={toggleMenu}>
			<img loading="lazy" loading="lazy" width="49" height="49" src="{siteSettings.Header.hamburgerLight.data ? domain+siteSettings.Header.hamburgerLight.data.attributes.url : HamburgerLight}" alt="hamburger" class="light-hamburger">
			<img loading="lazy" loading="lazy" width="49" height="49" src="{siteSettings.Header.hamburgerDark.data ? domain+siteSettings.Header.hamburgerDark.data.attributes.url : HamburgerDark}" alt="hamburger" class="dark-hamburger">
		</div>
	{/if}
		...
		{#if isOpen && innerWidth < 767}
			<div class="{isOpen ? "mobile-nav open" : "mobile-nav" }" in:fly={{
				...
				<a href="/" class="mobile-menu-logo">
					<img loading="lazy" loading="lazy" src={siteSettings.Header.Logo.data ? domain+siteSettings.Header.Logo.data.attributes.url : logo} alt="ULFBUILT" class="logo"/>
				</a>				
