...
<PageBanner
	title={page.Title ? page.Title : 'Services'}
	extraClass="services"
	subTitle={page.Subheading ? page.Subheading : ''}
	banner="{url}{page.Cover.data[0].attributes.formats.large_x2.url
		? page.Cover.data[0].attributes.formats.large_x2.url
		: page.Cover.data[0].attributes.url}"
/>
					...
					<div class="service-b__service-box__service-box-inner">
						<div class="service-b__service-box__service-box-inner__service-icon">
							<img
								...
								id="about_icon1"
								gsap-duration="2"
								src="{url}{page.section1item1icon.data.attributes.url}"
								alt={page.section1item1heading}
								width={page.section1item1icon.data.attributes.width}
								height={page.section1item1icon.data.attributes.height}
							/>
						</div>
						<h4 in:slide gsap-start="top 90%" id="about_title_icon1" gsap-duration="2">
							{page.section1item1heading ? page.section1item1heading : ''}
						</h4>
					</div>
					<p in:fadeIn gsap-start="top 90%" id="about_content_icon1" gsap-duration="2">
						{page.section1item1text ? page.section1item1text : ''}
					</p>
				</div>
			</Col>
			<Col md="6" sm="6" xs="12">
					...
					<div class="service-b__service-box__service-box-inner">
						<div class="service-b__service-box__service-box-inner__service-icon">
							<img
								...
								id="about_icon2"
								gsap-duration="2"
								src="{url}{page.section1item2icon.data.attributes.url}"
								alt={page.section1item2heading}
								width={page.section1item2icon.data.attributes.width}
								height={page.section1item2icon.data.attributes.height}
							/>
						</div>
						<h4 in:slide gsap-start="top 90%" id="about_title_icon2" gsap-duration="2">
							{page.section1item2heading ? page.section1item2heading : ''}
						</h4>
					</div>
					<p in:fadeIn gsap-start="top 90%" id="about_content_icon2" gsap-duration="2">
						{page.section1item2text ? page.section1item2text : ''}
					</p>
				</div>
			</Col>
			<Col md="6" sm="6" xs="12">
				<div class="service-b__service-box">
					...
					<p in:fadeIn gsap-start="top 90%" id="about_content_icon3" gsap-duration="2">
						{page.section1item3text ? page.section1item3text : ''}
					</p>
				</div>
			</Col>
			<Col md="6" sm="6" xs="12">
				<div class="service-b__service-box">
					...
					<p in:fadeIn gsap-start="top 90%" id="about_content_icon4" gsap-duration="2">
						{page.section1item4text ? page.section1item4text : ''}
					</p>
				</div>
			</Col>
			<!-- <Col md=6 sm=6 xs=12>
...
<section class="mx-10 sets-us-apart" in:slowDownSection id="sp-section1" gsap-start="top">
	<Container>
		<h2
			...
			gsap-duration="1"
		>
			{page.section2mainheading ? page.section2mainheading : ''}
		</h2>
			...
			<Col md="6" class="sets-us-apart__content">
				<div>
					<h4
						...
						gsap-duration="1.5"
					>
						{@html page.section2heading ? page.section2heading : ''}
					</h4>
					<div class="blue-color-background">
						<p
							class="text-right px-5 py-5"
							gsap-delay="1"
							in:fly
							id="about_sua_cont1"
							gsap-duration="2"
			...
			<Col md="6" class="imageCont">
				{#if page.section2image.data}
					<img
						...
						gsap-y="50"
						gsap-delay="0.5"
						src="{url}{page.section2image.data.attributes.formats.large.url
							? page.section2image.data.attributes.formats.large.url
							: page.section2image.data.attributes.url}"
						alt={page.section2heading}
						class="w-100"
						width={page.section2image.data.attributes.width}
						height={page.section2image.data.attributes.height}
					/>
				{/if}
			</Col>
		</Row>
...
<section class="mx-10 sets-us-apart" in:slowDownSection id="sp-section2" gsap-start="top">
	<Container>
		<Row
			noGutters
			class="justify-content-center flex-md-row flex-column-reverse sets-us-apart__row"
		>
			<Col md="6" class="imageCont">
				{#if page.section3image.data}
					<img
						...
						gsap-y="50"
						gsap-delay="0.5"
						src="{url}{page.section3image.data.attributes.formats.large.url
							? page.section3image.data.attributes.formats.large.url
							: page.section3image.data.attributes.url}"
						alt={page.section3heading}
						class="w-100"
					/>
				{/if}
			</Col>
			<Col md="6" class="sets-us-apart__content">
				<div>
					<h4
						class="txt-center pt-2 pb-3 md:py-3 pfont text-animate"
						in:textAnimate
						id="about_sua_title2"
						gsap-duration="1.5"
					>
						{@html page.section3heading ? page.section3heading : ''}
					</h4>
					<!-- <p class="px-5 txt-center py-5 blue-color-background">{@html page.section3text ? page.section3text : ''}</p> -->
					<div class="blue-color-background">
						<p
							class="txt-center px-5 py-5"
							in:fly
							id="about_sua_cont2"
							gsap-delay="1"
							gsap-duration="2"
			...
			<Col md="6" class="sets-us-apart__content">
				<div>
					<h4
						...
						gsap-duration="1.5"
					>
						{@html page.section4heading ? page.section4heading : ''}
					</h4>
			...
			<Col md="6" class="imageCont">
				{#if page.section4image.data}
					<img
						...
						gsap-delay="0.5"
						gsap-y="50"
						src="{url}{page.section4image.data.attributes.formats.large.url
							? page.section4image.data.attributes.formats.large.url
							: page.section4image.data.attributes.url}"
						alt={page.section4heading}
						class="w-100"
					/>
				{/if}
			</Col>
...
<section class="height-100vh fullwidth" in:fly id="about_banneronly_img_section" gsap-y="10">
	{#if page.section5image.data}
		<img
			loading="lazy"
			in:scaleUp
			id="about_banneronly_img"
			gsap-duration="1.5"
			src="{url}{page.section5image.data.attributes.formats.large.url
				? page.section5image.data.attributes.formats.large.url
				: page.section5image.data.attributes.url}"
			alt={page.title}
			class="w-100 image-scale-up"
		/>
	{/if}
</section>
<section class="reimagine">
	<Container>
		<h2
			...
			gsap-start="top 20%"
		>
			{page.section6heading ? page.section6heading : ''}
		</h2>
		<p
			class="md:mb-2 mb-0 pt-2 md:py-3 two-columns text-justify [&>:last-child]:!mb-[2rem]"
			in:fadeIn
			id="about_reimagine_cont"
			gsap-duration="1"
			gsap-y="20"
			gsap-start="top 20%"
		>
			{@html page.section6text ? page.section6text : ''}
		</p>
		<div class="text-right">
			<a class="btn btn-secondary" href={page.section6btnUrl ? page.section6btnUrl : '#'}
				>{page.section6btn ? page.section6btn : 'Button'}</a
			>
		</div>
	</Container>
</section>
		...
		<Row>
			<Col md="12">
				<h2
					...
					gsap-duration="1"
				>
					{page.ExploreProjects.Heading ? page.ExploreProjects.Heading : 'Explore our Projects...'}
				</h2>
			</Col>
			<!-- </Animate>		 -->
			{#each featuredProjects.sort(() => 0.5 - Math.random()).slice(0, 2) as featuredProject, index}
				<Col md="6">
					...
					>
						<a
							href="portfolio/{featuredProject.attributes.slug}"
							data-sveltekit-reload
							class="zoomImg"
						>
							<!-- <img loading="lazy" src="{url}{featuredProject.attributes.featuredImage.data.attributes.url}" alt="{featuredProject.attributes.featuredImage.data.attributes.alternativeText}"> -->
							{#if featuredProject.attributes.featuredImage.data != null}
								<img
									loading="lazy"
									src="{url}{featuredProject.attributes.featuredImage.data.attributes.formats.large
										.url
										? featuredProject.attributes.featuredImage.data.attributes.formats.large.url
										: featuredProject.attributes.featuredImage.data.attributes.url}"
									alt={featuredProject.attributes.featuredImage.data.attributes.alternativeText}
								/>
							{:else}
								<img
									loading="lazy"
									src={fallback ? url + fallback.attribute.url : noFeatured}
