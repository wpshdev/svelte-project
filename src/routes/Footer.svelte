                ...
                <Col>
                    ...
                    <div class="footer__post-footer">
                        <div class="footer__post-footer__social">
                            ...
                            <span class="footer__post-footer__social__icon footer__post-footer__social__icon--insta" aria-label="Linkedin">
                                <a href="{siteSettings.SiteDetails.liLink ? siteSettings.SiteDetails.liLink : '#'}" target="_blank">
                            ...
                            <span class="footer__post-footer__social__icon footer__post-footer__social__icon--insta" aria-label="Instagram">
