	...
	<Col md="3">
		<div class="slider-caption">
			<div class="slider-caption__heading">
				...
				<h2 class="text-animate secondary-font" in:textAnimate id="carousel-heading">
					{heading ? heading : ''}
				</h2>
			</div>
				...
				{#each featuredProjects.data as project, index}
					<div class="embla__slide">
						<div class="slider-container__carousel-cell">
							<a
								href="/portfolio/{project.attributes.slug ? project.attributes.slug : '#'}"
							...
							>
								{#if project.attributes.featuredImage.data != null}
									<img
										...
										draggable="false"
										src={domain +
											project.attributes.featuredImage.data.attributes.formats.large.url ||
											domain + project.attributes.featuredImage.data.attributes.url}
										alt={project.attributes.featuredImage.data.attributes.alternativeText
											? project.attributes.featuredImage.data.attributes.alternativeText
											: 'Image'}
										srcset="{domain}{project.attributes.featuredImage.data.attributes.formats.medium
											.url
											? project.attributes.featuredImage.data.attributes.formats.medium.url
											: project.attributes.featuredImage.data.attributes.url} 768w"
										sizes="(max-width: 768px) 1024px"
									/>
								{:else}
									{#await promise then fallback}
										<img
											loading="eager"
											src={fallback ? domain + fallback.attributes.url : noFeatured}
											alt={project.attributes.title ? project.attributes.title : 'Image'}
											draggable="false"
											srcset="{fallback ? domain + fallback.attributes.url : noFeatured} 768w"
											sizes="(max-width: 768px) 1024px"
										/>
									{/await}
								{/if}
