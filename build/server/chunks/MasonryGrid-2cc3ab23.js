import { L, C, b, z, d, P, R as R$1, A as A$1, I, N } from './index-87618b6e.js';
import { E, M as M$1, R } from './Row-0fc34542.js';
import e from 'axios';
...
const x={code:".insight.svelte-pyzmc3.svelte-pyzmc3{background-color:#F2F2F2;padding:4rem 0;margin-bottom:0}@media(max-width: 767px){.insight.svelte-pyzmc3.svelte-pyzmc3{padding-left:0;padding-right:0}}.insight__pre-heading.svelte-pyzmc3.svelte-pyzmc3{color:#00ADEE;margin-bottom:2rem;display:block}.insight__content__wrapper.svelte-pyzmc3.svelte-pyzmc3{padding-left:4rem}@media(max-width: 767px){.insight__content__wrapper.svelte-pyzmc3.svelte-pyzmc3{padding:0}}.insight__content__wrapper__pre-heading.svelte-pyzmc3.svelte-pyzmc3{color:#263A63;font-weight:500}@media(max-width: 767px){.insight__content__wrapper__pre-heading.svelte-pyzmc3.svelte-pyzmc3{padding:1rem 0 0}}.insight__content__wrapper.svelte-pyzmc3 h2.svelte-pyzmc3{margin:1rem 0 2rem}.insight__content__wrapper__btns.svelte-pyzmc3.svelte-pyzmc3{text-align:center}.insight__content__wrapper.svelte-pyzmc3 .btn-inverted.svelte-pyzmc3{background-color:#fff}",map:null},A="https://strapi.ulfbuilt.com:1337",M=L((t,a,c,o)=>{let d$1=l();async function l(){const r="https://strapi.ulfbuilt.com:1337/api/global-article-cta?populate=deep,2",e$1={Authorization:"Bearer "};try{return (await e.get(r,{headers:e$1})).data.data.attributes}catch(i){console.error("Error fetching data:",i);}}return t.css.add(x),`${function(r){return C(r)?(r.then(null,b),`
`):function(e){return ` 
	<section class="insight svelte-pyzmc3">${z(E,"Container").$$render(t,{},{},{default:()=>`${z(M$1,"Row").$$render(t,{},{},{default:()=>`${z(R,"Col").$$render(t,{},{},{default:()=>`<span class="insight__pre-heading svelte-pyzmc3">${d(e.leftPreHeading)}</span>`})}`})}
			${z(M$1,"Row").$$render(t,{},{},{default:()=>`${z(R,"Col").$$render(t,{md:"6",class:""},{},{default:()=>`<img src="${d(A,!0)+d(e.image.data.attributes.formats.large.url,!0)}" alt="Stair">`})}
				${z(R,"Col").$$render(t,{md:"6",class:"my-auto"},{},{default:()=>`<div class="insight__content"><div class="insight__content__wrapper svelte-pyzmc3"><div class="insight__content__wrapper__pre-heading svelte-pyzmc3">${d(e.rightPreHeading)}</div>
							<h2 class="svelte-pyzmc3">${d(e.Heading)}</h2>
							<!-- HTML_TAG_START -->${e.paragprah}<!-- HTML_TAG_END -->
							<div class="insight__content__wrapper__btns svelte-pyzmc3"><a${P("href",e.leftBtnUrl,0)} class="btn btn-secondary">${d(e.leftBtnTitle)}</a> <a${P("href",e.rightBtnUrl,0)} class="btn btn-inverted svelte-pyzmc3">${d(e.rightBtnTitle)}</a></div></div></div>`})}`})}`})}</section>
`}(r)}(d$1)}`}),T=L((t,a,c,o)=>{let{GridClass:d}=a;R$1();let l,r,e={};A$1(()=>{});function i(){return r}return a.GridClass===void 0&&c.GridClass&&d!==void 0&&c.GridClass(d),a.getInstance===void 0&&c.getInstance&&i!==void 0&&c.getInstance(i),`<div${I([N(e)],{})}${P("this",l,0)}>${o.default?o.default({}):""}</div>`}),_=T;let v;typeof _=="object"?v=_:v=class extends _{constructor(a){a.props.GridClass=MasonryGrid,super(a);}};

export { M, v };
//# sourceMappingURL=MasonryGrid-2cc3ab23.js.map
