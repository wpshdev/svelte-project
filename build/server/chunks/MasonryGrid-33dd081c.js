import { L, C, b, z, d, P, R as R$2, A as A$1, I, N } from './index-87618b6e.js';
...
`}(a)}(d$1)}`}),S=L((t,r,i,c)=>{let{GridClass:d}=r;R$2();let l,a,e={};A$1(()=>{});function o(){return a}return r.GridClass===void 0&&i.GridClass&&d!==void 0&&i.GridClass(d),r.getInstance===void 0&&i.getInstance&&o!==void 0&&i.getInstance(o),`<div${I([N(e)],{})}${P("this",l,0)}>${c.default?c.default({}):""}</div>`}),p=S;let g;typeof p=="object"?g=p:g=class extends p{constructor(r){r.props.GridClass=MasonryGrid,super(r);}};

export { R, g };
//# sourceMappingURL=MasonryGrid-33dd081c.js.map
