import { L, C, E as E$1, z, d, P, T, R as R$1, I, M as M$1 } from './index2-8ecb42f0.js';
import { E as E$2, M, R } from './Row-a840427f.js';
import o from 'axios';
...
const x={code:".insight.svelte-rznqmq.svelte-rznqmq{background-color:#F2F2F2;padding:4rem 0;margin-bottom:0;min-height:20vh}@media(max-width: 767px){.insight.svelte-rznqmq.svelte-rznqmq{padding-left:0;padding-right:0}}.insight__pre-heading.svelte-rznqmq.svelte-rznqmq{color:#00ADEE;margin-bottom:2rem;display:block;font-weight:500}.insight__content__wrapper.svelte-rznqmq.svelte-rznqmq{padding-left:4rem}@media(max-width: 767px){.insight__content__wrapper.svelte-rznqmq.svelte-rznqmq{padding:0}}.insight__content__wrapper__pre-heading.svelte-rznqmq.svelte-rznqmq{color:#263A63;font-weight:500}@media(max-width: 767px){.insight__content__wrapper__pre-heading.svelte-rznqmq.svelte-rznqmq{padding:1rem 0 0}}.insight__content__wrapper.svelte-rznqmq h2.svelte-rznqmq{margin:1rem 0 2rem;font-weight:400}.insight__content__wrapper__btns.svelte-rznqmq.svelte-rznqmq{margin-top:1.5rem}.insight__content__wrapper.svelte-rznqmq .btn.svelte-rznqmq{padding:0.7rem 3.125rem;font-size:1.25rem}.insight__content__wrapper.svelte-rznqmq .btn-secondary.svelte-rznqmq{margin-right:1.25rem}.insight__content__wrapper.svelte-rznqmq .btn-inverted.svelte-rznqmq{background-color:#fff}.insight__content__wrapper.svelte-rznqmq .btn-inverted.svelte-rznqmq:hover{background-color:#263A63;border-color:#fff}@media(max-width: 991px){.insight__content__wrapper.svelte-rznqmq .btn.svelte-rznqmq{margin-top:1rem}}",map:null},G="https://strapi.ulfbuilt.com:1337",E=L((t,r,i,l)=>{let d$1=c();async function c(){const n="https://strapi.ulfbuilt.com:1337/api/global-article-cta?populate=deep,2",e={Authorization:"Bearer "};try{return (await o.get(n,{headers:e})).data.data.attributes}catch(o){console.error("Error fetching data:",o);}}return t.css.add(x),`${function(n){return C(n)?(n.then(null,E$1),`
`):function(e){return ` 
	<section class="insight svelte-rznqmq">${z(E$2,"Container").$$render(t,{},{},{default:()=>`${z(M,"Row").$$render(t,{},{},{default:()=>`${z(R,"Col").$$render(t,{},{},{default:()=>`<span class="insight__pre-heading svelte-rznqmq">${d(e.leftPreHeading)}</span>`})}`})}
			${z(M,"Row").$$render(t,{},{},{default:()=>`${z(R,"Col").$$render(t,{md:"6",class:""},{},{default:()=>`<img src="${d(G,!0)+d(e.image.data.attributes.formats.large.url,!0)}" alt="Stair">`})}
				${z(R,"Col").$$render(t,{md:"6",class:"my-auto"},{},{default:()=>`<div class="insight__content"><div class="insight__content__wrapper svelte-rznqmq"><div class="insight__content__wrapper__pre-heading svelte-rznqmq">${d(e.rightPreHeading)}</div>
							<h2 class="svelte-rznqmq">${d(e.Heading)}</h2>
							<!-- HTML_TAG_START -->${e.paragprah}<!-- HTML_TAG_END -->
							<div class="insight__content__wrapper__btns svelte-rznqmq"><a${P("href",e.leftBtnUrl,0)} class="btn btn-secondary svelte-rznqmq">${d(e.leftBtnTitle)}</a> <a${P("href",e.rightBtnUrl,0)} class="btn btn-inverted svelte-rznqmq">${d(e.rightBtnTitle)}</a></div></div></div>`})}`})}`})}</section>
`}(n)}(d$1)}`}),_=L((t,r,i,l)=>{let{GridClass:d}=r;T();let c,n,e={};R$1(()=>{});function o(){return n}return r.GridClass===void 0&&i.GridClass&&d!==void 0&&i.GridClass(d),r.getInstance===void 0&&i.getInstance&&o!==void 0&&i.getInstance(o),`<div${I([M$1(e)],{})}${P("this",c,0)}>${l.default?l.default({}):""}</div>`});let v;typeof _=="object"?v=_:v=class extends _{constructor(r){r.props.GridClass=MasonryGrid,super(r);}};

export { E, v };
//# sourceMappingURL=MasonryGrid-84354e9e.js.map
